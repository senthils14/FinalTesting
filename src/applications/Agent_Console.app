...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <tab>Finance_Account__c</tab>
    <tab>ChargentOrders__ChargentOrder__c</tab>
    <tab>Notification_Messages__c</tab>
    <tab>Chargent_Queues__Batch_Queue_Recalculation__c</tab>
    <workspaceMappings>
        <mapping>
            <tab>ChargentOrders__ChargentOrder__c</tab>
        </mapping>
